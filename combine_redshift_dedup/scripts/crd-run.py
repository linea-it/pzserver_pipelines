...
def main(config_path, cwd="."):
    ...
    if combine_type == "just_concatenate":
        ...
        logger.info(f"✅ Final concatenated catalog saved at {final_base_path}.{output_format}")
        ...
        save_dataframe(df_final, final_base_path, output_format)
        logger.info(f"✅ Final deduplicated catalog saved at {final_base_path}.{output_format}")
